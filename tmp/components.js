...
}}.call(this,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined));;return pug_html;},inputDateDays:function(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (Date, attrs) {var i, days, startDay, cDate, lastDay, today;
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
if (header) {
pug_html = pug_html + (null == (pug_interp = header) ? "" : pug_interp);
}
else {
pug_html = pug_html + "\u003Cdiv class=\"g\"\u003E\u003Cspan class=\"btn\" d-click=\"go up\"\u003E🡅\u003C\u002Fspan\u003E\u003Cspan class=\"btn\" d-click=\"go prev\"\u003E🡄\u003C\u002Fspan\u003E\u003Cspan class=\"btn\" d-click=\"go next\"\u003E🡆\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";}.call(this,"attrs" in locals_for_with?locals_for_with.attrs:typeof attrs!=="undefined"?attrs:undefined,"header" in locals_for_with?locals_for_with.header:typeof header!=="undefined"?header:undefined));;return pug_html;},inputDateMonths:function(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (attrs) {pug_html = pug_html + "\u003Cdiv class=\"input-date-view grow1 grid grid-c xs4 pt\"\u003E";
...
pug_html = pug_html + (null == (pug_interp = CoreHTML.inputDateYears(locals)) ? "" : pug_interp);
  break;
}}.call(this,"attrs" in locals_for_with?locals_for_with.attrs:typeof attrs!=="undefined"?attrs:undefined,"input" in locals_for_with?locals_for_with.input:typeof input!=="undefined"?input:undefined));;return pug_html;},popupAutocomplete:function(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Cdiv class=\"card flat f-col\"\u003E\u003C\u002Fdiv\u003E";;return pug_html;},_:(function(){var e;return e=document.createElement("div"),function(r,t,i){var n,s,o,p;if(!(s=this[r]))throw"Unknown component: "+r;for(o=Array.isArray(t)?t.map(s).join(""):s(t),i&&(o=o.repeat(i)),e.innerHTML=o,p=e.childNodes,n=document.createDocumentFragment();p.length;)n.appendChild(p[0]);return n}})()};
